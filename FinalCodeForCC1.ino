...
//  
//  if(Gesture.equals("b")){
//    int p1 = 3108; //Servo 1 goal position
//    int p2 = 1514; //Servo 2 goal position
//    int p3 = 2879; //Servo 3 goal position
//    int p4 = 2048; //Servo 4 goal position
//    int p5 = 2048; //Servo 5 goal position
//
//    pck.setNGoalPositionPacket(p1,p2,p3, p4, p5);
...
//  
//  if(Gesture.equals("c")){
//    int p1 = 742; //Servo 1 goal position
//    int p2 = 1635; //Servo 2 goal position
//    int p3 = 2939; //Servo 3 goal position
//    int p4 = 2048; //Servo 4 goal position
//    int p5 = 2048; //Servo 5 goal position
//
//    pck.setNGoalPositionPacket(p1,p2,p3, p4, p5);
...
//    
//  if(Gesture.equals("d")){
//    int p1 = 2404; //Servo 1 goal position
//    int p2 = 1345; //Servo 2 goal position
//    int p3 = 2523; //Servo 3 goal position
//    int p4 = 2048; //Servo 4 goal position
//    int p5 = 2048; //Servo 5 goal position
//
//    pck.setNGoalPositionPacket(p1,p2,p3, p4, p5);
